...
<head>
    ...
    <!-- Ionicons -->
    <link rel="stylesheet" href="{{asset('/AdminLTE-3.0.5/https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css')}}">
...
<!-- Bootstrap 4 -->
<script src="{{asset('/Admi
nLTE-3.0.5/plugins/bootstrap/js/bootstrap.bundle.min.js')}}"></script>
<!-- ChartJS -->
